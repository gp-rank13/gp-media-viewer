...
class MediaViewer : public juce::Component
{
  public:
    MediaViewer();
    ...
    void static displayMedia(String path); 
    void static playbackStopped();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MediaViewer)
};
